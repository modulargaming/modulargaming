Feature: Create
        ...
        Scenario: Create with invalid to_id
                When I fill in the following:
                        | to_id         | 1         |
                        | subject            | Subject |
                        | text         | Text         |
                And I press "Send"
                Then I should see "to_id must be numeric "

        Scenario: Create with too long to_id
                When I fill in the following:
                        | to_id         | 1234567         |
                        | subject            | Subject |
                        | text         | Text         |
                And I press "Send"
                Then I should see "to_id must not exceed 6 characters long"

        Scenario: Create with no to_id
                When I fill in the following:
                        | to_id         |          |
                        | subject            | Subject |
                        | text         | Text         |
                And I press "Send"
                Then I should see "to_id must not be empty"
