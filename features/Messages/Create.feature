Feature: Create
        ...
        Scenario: Create with invalid receiver_id
                When I fill in the following:
                        | receiver_id         | 1         |
                        | subject            | Subject |
                        | text         | Text         |
                And I press "Send"
                Then I should see "receiver_id must be numeric "

        Scenario: Create with too long receiver_id
                When I fill in the following:
                        | receiver_id         | 1234567         |
                        | subject            | Subject |
                        | text         | Text         |
                And I press "Send"
                Then I should see "receiver_id must not exceed 6 characters long"

        Scenario: Create with no receiver_id
                When I fill in the following:
                        | receiver_id         |          |
                        | subject            | Subject |
                        | text         | Text         |
                And I press "Send"
                Then I should see "receiver_id must not be empty"
